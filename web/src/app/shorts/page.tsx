...
function ShortsFeed() {
  ...
  const { liked, toggleLike, toggleDislike, disliked, subscribed, toggleSubscribe } = useAppStore();
  ...
  return (
    <div className="relative h-[calc(100vh-var(--topbar-h))] bg-black">
      ...
      <button
        type="button"
        className="absolute right-3 top-3 z-20 grid h-10 w-10 place-items-center rounded-full bg-black/50 text-white md:right-6"
            ...
            <section key={short.id} className="relative flex h-full items-center justify-center">
              ...
              <div className="absolute bottom-20 left-4 right-20 z-10 text-white md:bottom-10">
                {channel && (
                  <div className="pointer-events-auto mb-2 flex items-center gap-2">
                    <Link href={`/channel/${channel.handle}`} className="inline-flex items-center gap-2">
              ...
              <div className="absolute bottom-24 right-3 z-10 flex flex-col items-center gap-4 text-white md:bottom-16">
                ...
                >
                  ...
                  <span className="text-xs">{copied && i === active ? "Copied" : "Share"}</span>
                </button>
              </div>
            </section>
          );
