...
export default function LibraryPage() {
  const { history, liked, watchLater, customPlaylists } = useAppStore();
    ...
    <div className="px-3 py-4 md:px-6 md:py-5">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 md:grid-cols-4">
        {[
          ...
          { href: "/playlist/pl-weekend", label: "Playlists", icon: IconPlaylist, meta: `${allPlaylists.length} lists` },
      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
          ...
          {recent.length === 0 && (
            <p className="text-sm text-text-muted sm:col-span-2">Nothing watched yet.</p>
          )}
        </div>
      </section>
