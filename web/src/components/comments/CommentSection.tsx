  ...
  return (
    <section className="mt-6">
      <div className="mb-4 flex flex-wrap items-center gap-3">
        ...
        <button
          type="button"
          className="pill-btn ml-auto text-sm"
      ...
      <form onSubmit={onSubmit} className="mb-6 flex gap-3">
        <div className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-gradient-to-br from-rose-500 to-orange-400 text-sm font-bold">
          E
        </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-2 flex items-center gap-3 text-xs text-text-muted">
                <button type="button" className="inline-flex items-center gap-1 hover:text-text">
                  <IconLike size={14} /> {formatViews(c.likes)}
                </button>
