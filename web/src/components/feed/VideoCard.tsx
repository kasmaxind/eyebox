...
export function VideoCard({
  ...
  if (horizontal) {
    return (
      <Link href={`/watch/${video.id}`} className="group flex gap-3 rounded-xl p-1 transition hover:bg-bg-hover/60">
      ...
      <div className="mt-3 flex gap-3">
        ...
        <div className="min-w-0">
          <Link href={`/watch/${video.id}`}>
            <h3 className="line-clamp-2 font-semibold leading-snug tracking-tight group-hover:text-white">
              {video.title}
            </h3>
          </Link>
